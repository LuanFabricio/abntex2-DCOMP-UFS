...
uma matriz é desliza pelas células da imagem, salvando apenas o maior valor dessa área na matriz de saída.
Fazendo isso a camada consegue reduzir o tamanho da matriz de entrada, fazendo com que poder computacional seja
reduzido, junto com o uso de memória.

\subsection{Camada totalmente conectada}\label{cap_conceitos_cnn_totalmente}
A camada totalmente conectada (\textit{fully connected layer}) seria a camada final,
pois as camadas anteriores (convolução e \textit{pooling}), são responsáveis por extrair as
características da imagem de entrada. Depois disso, a camada totalmente conectada vai
transformar esses dados em uma classe final.
