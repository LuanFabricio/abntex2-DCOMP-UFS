...
% Fonte: https://www.tensorflow.org/static/tutorials/images/data_augmentation_files/output_1ZjVI24nIH0S_0.png
% Na figura, temos um exemplo de uma imagem que sofreu uma transformação para efetuar um \textit{data augmentation}.
...
% TODO: terminar de reescrever sobre poda
A poda de redes neurais tem como foco eliminar conexões ou neurônios que não apresentam uma grade contribuição para a
rede.
Essa operação, é muito vantajosa para reduzir o peso da rede, pois uma vez que temos

A operação de poda procura pesos com valores abaixo de um determinado limiar e os define igual a zero, assim deixando
a rede neural mais esparsa, o que facilita o processo de compressão.
Além disso, o processo de poda reduz o superajuste da rede, uma vez que remove pesos pouco importantes para a rede
