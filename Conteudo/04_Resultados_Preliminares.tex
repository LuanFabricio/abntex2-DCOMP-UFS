...
O método de avaliação do modelo foi baseado no artigo Triplet Distillation \cite{triplet_distillation_face_recognition}
, onde são extraídas as características imagens e suas versões com \textit{flip}. Depois disso, os vetores de
característica são utilizados para a etapa de verificação de face, utilizando similaridade de cosseno.
