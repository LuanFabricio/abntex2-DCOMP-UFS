...
Com isso esses resultados, foi gerada a \autoref{tempo_inferencia_modelos}, onde as métricas são dos modelos
descritos na \autoref{sec_modelo_utilizado}.
...
A \autoref{acuracia_tempo_inferencia_modelos_esp} mostra o resultado dos testes feitos no ESP,
...
, e com uma versão com apenas três imagens do \textit{dataset} Faces - UFS, onde o foco desse
experimento foi o medir o tempo de inferência dos modelos. Pode-se notar que
