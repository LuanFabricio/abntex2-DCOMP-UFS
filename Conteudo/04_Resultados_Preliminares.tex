...
\begin{tabular}{ |c|c|c|c|c| }
	\hline
	\textbf{Modelo} & Quantização & \textbf{Acurácia} & \textbf{Tempo médio de inferência (ms)} & \textbf{Método de treinamento} \\
	\hline
	MobileFaceNet 	&-	& 	100.00\% 	& $140 \pm 0.00266$ & Pré-treinado + \textit{Triplet Loss} \\
	MobileFaceNet 	&uint8	& 	100.00\% 	& $453 \pm 0.00441$ & Pré-treinado + \textit{Triplet Loss} \\
